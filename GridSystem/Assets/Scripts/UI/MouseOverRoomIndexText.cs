...
public class MouseOverRoomIndexText : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if(TMP_text == null)
        {
            Debug.LogError("MouseOverTileTypeText: KeyNotFoundException TextMeshPro UI component on this object ");
            this.enabled = false;
            return;
        }
    ...
    void Update()
    {
        ...
        TMP_text.text = "Room Index: " + t.world.rooms.IndexOf(t.room);
    }
}
